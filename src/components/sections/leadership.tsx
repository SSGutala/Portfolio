export default function LeadershipSection() {
  return (
    <section id="leadership" className="pt-0 md:pt-0 min-h-[90vh] py-20 md:py-32">
          ...
          <div className="flex flex-col items-center text-left w-full space-y-8">
            ...
            <div className="w-full space-y-4 text-lg text-muted-foreground">
                ...
                <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>Electromechanical builds</li>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 mt-2">
                    <li>Co-conceived and architected the university’s first hardware hackathon, establishing the event structure, technical framework, and safety protocols required for hardware-based project development.</li>
                    <li>Designed a model that supported multidisciplinary teams across electrical engineering, computer engineering, mechanical engineering, computer science, and design.</li>
                  </ul>
                </div>
                <div>
                  <p className="font-semibold italic">Organizational Leadership</p>
                  <ul className="list-disc list-inside space-y-1 mt-2">
                    <li>Built and led a 19-person cross-functional committee responsible for logistics, sponsorship acquisition, finance, operations, and marketing.</li>
                    <li>Implemented structured planning workflows, documentation, and governance practices that enabled consistent event execution.</li>
                  </ul>
                </div>
                 <div>
                  <p className="font-semibold italic">Sponsorship & Funding</p>
                  <ul className="list-disc list-inside space-y-1 mt-2">
                    <li>Secured $35K+ in corporate sponsorships, enabling procurement of components, tools, microcontrollers, sensors, and fabrication materials.</li>
                    <li>Developed sponsor value propositions aligned with industry needs in automation and engineering innovation.</li>
                  </ul>
                </div>
                 <div>
                  <p className="font-semibold italic">Event Execution</p>
                  <ul className="list-disc list-inside space-y-1 mt-2">
                    <li>Directed the inaugural hardware hackathon, drawing 200+ participants and facilitating workshops, mentorship, and evaluation by academic and industry professionals.</li>
                  </ul>
                </div>
              </div>
               <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 mt-2">
                    <li>Provided strategic guidance to new leadership on event execution, budgeting, sponsorship outreach, and hardware procurement strategies.</li>
                    <li>Helped maintain continuity and uphold operational standards as the event expanded and matured.</li>
                     <li>Supported planning reviews, risk assessment, and scaling decisions.</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="w-full space-y-4 text-lg text-muted-foreground">
                ...
                <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>Enabled hundreds of students to design functional physical prototypes, bridging academic theory and real-world engineering practice.</li>
                    <li>Built a sustainable event model and governance framework that has allowed HackOverflow to continue successfully under new leadership.</li>
                </ul>
            </div>
             ...
             <div className="w-full space-y-4 text-lg text-muted-foreground">
                ...
                <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>Sponsorship and stakeholder management</li>
