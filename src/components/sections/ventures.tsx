...
export default function VenturesSection() {
  return (
    ...
    <h4 className="text-xl font-bold mb-4">Phase 1 — Vision Architecture & Strategic Partner Alignment</h4>
    <p>
      Focused on defining the mission, identifying real-world constraints, and modeling how physical + digital learning
      can work sustainably in underserved communities.
    </p>

    <h5 className="text-xl font-semibold mb-4 mt-2">Key Activities</h5>
  ...
  {/* Phase 2 */}
  <div className="phase space-y-3">
    <h4 className="text-xl font-bold mb-4">Phase 2 — Community Research & Needs Discovery</h4>
    <p>
      Conducted field research in Hyderabad slum communities to understand real barriers to learning — beyond just a lack of content
      or devices.
    </p>
      ...
      <table className="w-full border-collapse">
        ...
        <tbody>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            ...
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Understood daily routines, learning gaps, financial pressure, and access to smartphones, internet, and safe study space.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Child Engagement Sessions</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Ran drawing, storytelling, and simple learning games to build rapport and observe motivation and attention span.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Learning Constraints</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Identified limited device access, absence of quiet learning environments, and the need for on-ground supervision and support.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Cultural Understanding</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Observed the central role of trust, family permission, and emotional safety in whether children will consistently attend sessions.
            </td>
          </tr>
        </tbody>
      </table>
  ...
  {/* Phase 3 */}
  <div className="phase space-y-3">
    <h4 className="text-xl font-bold mb-4">Phase 3 — Program Model Definition & Business Design</h4>
      ...
      <table className="w-full border-collapse">
        ...
        <tbody>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            ...
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Proposed a remote learning pod structure: 10–15 children, local facilitator, and tablet-based AI guidance for basic literacy and numeracy.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Business Model Canvas</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Mapped key partners (NGOs, local schools, edtech tools, volunteers, global donors) and core activities for sustainable program delivery.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Scalability Planning</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Modeled a phased expansion path: pilot pods → neighborhood clusters → multi-community hubs leveraging AI-assisted content.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Volunteer Enablement</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Defined structured roles: on-ground facilitators, remote mentors, and AI-learning supervisors responsible for pacing and engagement.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Funding Pathway</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Designed a donations funnel for education kits, shared devices, and pod setup costs, including recurring sponsorship options.
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <p className="mt-2 font-semibold">
      Outcome → Designed a “Community + AI Hybrid Learning Model” centered on structured guidance, mentorship, and basic digital tools—not full-tech
      dependency.
    </p>
  </div>
  ...
  {/* Phase 4 */}
  <div className="phase space-y-3">
    <h4 className="text-xl font-bold mb-4">Phase 4 — Pre-Launch Validation & Early Engagement</h4>
    <p>
      ...
      <table className="w-full border-collapse">
        ...
        <tbody>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            ...
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Organized distribution of stationery, books, snacks, and clothing to children in slum communities as a first touchpoint.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Volunteer Field Visits</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Spent time on the ground with local leaders, observing interest levels, testing classroom engagement, and validating curiosity.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Trust-Building</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Parents and early volunteers expressed willingness to participate in a structured after-school learning pod once launched.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Program Acceptance</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Existing school partners endorsed the hybrid model and agreed to host the first pilot pod using their current facilities.
            </td>
          </tr>
        </tbody>
      </table>
  ...
  {/* Outcome & Status */}
  <div className="phase space-y-3">
    <h4 className="text-xl font-bold mb-4">Outcome & Current Status</h4>
      ...
      <table className="w-full border-collapse">
        ...
        <tbody>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            ...
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Confirmed through parent interviews, child engagement, and volunteer enthusiasm for structured after-school learning.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Parent Support Readiness</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Majority of parents expressed willingness to send children to nearby learning pods if safety and trust are maintained.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">Digital Readiness</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Device access is low, but communities are open to shared devices and structured tech-aided learning when properly supervised.
            </td>
          </tr>
          <tr className="border-t border-[#e4d7c7] hover:bg-[#efe3d4] transition-colors">
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">NGO Partner Alignment</td>
            <td className="px-4 py-3 text-left align-top text-sm text-neutral-800">
              Partner organization agreed in principle to pilot the first learning pod using their existing school premises and community trust.
            </td>
          </tr>
        </tbody>
      </table>
  ...
  <div className="phase space-y-3">
    ...
    <h5 className="text-xl font-semibold mb-4 mt-4">Next Steps (Planned — Not Yet Executed)</h5>
    <ul className="list-disc list-inside">
