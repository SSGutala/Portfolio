       ...
       <div className="max-w-6xl mx-auto px-6 md:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-16">
            Through <a href="https://kyropartners.co" target="_blank" rel="noopener noreferrer" className="text-primary underline font-medium hover:text-copper transition-colors">Kyro Partners</a>, I provide consulting in web/app design and development, SEO, product direction and branding for early-stage founders and local businesses translating complex ideas into user-friendly, market-ready products. My focus is on bridging strategy and design, ensuring digital experiences are both functional and engaging.
          </p>
        </div>
